...
class QwenVLScorer(torch.nn.Module):
    def __init__(self,device="cuda",dtype=torch.bfloat16):
        ...
        Rule3: The criteria for judging background should be relatively stringent.
        Rule4: Please first provide a detailed analysis of the evaluation process, including the criteria for judging background alignment, then give a final
