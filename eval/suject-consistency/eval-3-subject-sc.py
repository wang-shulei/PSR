...
class GroundinoScorer(torch.nn.Module):
    ...
    @torch.no_grad()
    def __call__(self, prompt, images, ref_images_1, ref_images_2,ref_images_3, category1, category2,category3):
...
def main():
    ...
    for idx,item in enumerate(data):
        try:
            ...
            score=scorer(prompts,pil_images,ref1,ref2,ref3,category1,category2,category3)
